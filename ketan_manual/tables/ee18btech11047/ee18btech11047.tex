...
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{p_{1}=-5.14}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{z_{1}=-5}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{p_{2}=-3.09}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{z_{2}=-3}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{p_{3}=-1.87+6.60j}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{p_{4}=-1.87-6.60j}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{}	
\\
\hhline{|-|-|}
