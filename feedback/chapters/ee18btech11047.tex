...
\solution 
%The transfer function of the equivalent positive feedback circuit in Fig. \ref{fig:ee18btech11047_fig2} is  
%\begin{align}
%T &= \frac{G}{1-GH}
...
L(s) &= G(s)H(s)
\\
%&=\brak{1 + \frac{R_{2}}{R_{1}}}\brak{\frac{1}{3+sRC+\frac{1}{sRC}}}
%\end{align}
%\begin{align}
...
\end{align}
Also, from equation \eqref{eq:ee18btech11047_4}

\begin{align}
L(0) &\ge 1
\implies \brak{\frac{1+\frac{R_{2}}{R_{1}}}{3+j(0)}} &\geq 1
\\
\text{or, } \frac{R_{2}}{R_{1}} &\geq 2
\end{align}
...
\end{table}
%\solution From \eqref{eq:ee18btech11047_1} 
%\begin{align}
